...
import com.easier_minecraft.entity.ExplosiveArrowEntity;

public class ExplosionBowItem extends RangedWeaponItem {
	private static boolean doBreakBlock = false;

	public ExplosionBowItem(Item.Settings settings) {
		super(settings);
	}
